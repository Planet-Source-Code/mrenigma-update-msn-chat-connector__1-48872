...
Private Declare Function WideCharToMultiByte Lib "Kernel32" (ByVal CodePage As Long, ByVal dwFlags As Long, ByVal lpWideCharStr As Long, ByVal cchWideChar As Long, ByVal lpMultiByteStr As Long, ByVal cchMultiByte As Long, ByVal lpDefaultChar As String, lpUsedDefaultChar As Long) As Long
...
End Function
Public Function EncodeUTF8(ByVal sDecodeString As String)
      If sDecodeString = vbNullString Then Exit Function
      EncodeUTF8 = StrConv(WToA(sDecodeString, CP_UTF8, 0), vbUnicode)
End Function
Public Function DecodeUTF8(ByVal sDecodeString As String)
Dim sTemp As String

'      If InStr(1, sDecodeString, "À¨À") Then
'         ' Attempt Fix of bug
'         sDecodeString = Replace(sDecodeString, "À¨À", "À¨")
'      End If

      If sDecodeString = vbNullString Then Exit Function
      sTemp = WToA(sDecodeString, CP_ACP)
      
      DecodeUTF8 = AToW(sTemp, CP_UTF8)
